...
from personnel_appointments.models import Employee, Department, Account, Appointment, Template
from django.contrib.auth import update_session_auth_hash


class EmployeeSerializer(serializers.ModelSerializer):
    """
    Serializer for `personnel_appointments.models.Appointment`.
    """
...
class TemplateSerializer(serializers.ModelSerializer):
    """
    Serializer for `personnel_appointments.models.Template`.
    """
...
class DepartmentSerializer(serializers.ModelSerializer):
    """
    Serializer for `personnel_appointments.models.Department`.
    """
...
class AccountSerializer(serializers.ModelSerializer):
    """
    Serializer for `personnel_appointments.models.Account`.
    """
