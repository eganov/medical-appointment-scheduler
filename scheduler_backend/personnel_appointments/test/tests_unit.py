...
from personnel_appointments.test.resource import MOCK_DEPARTMENTS, MOCK_EMPLOYEE_BIANCA
import io
from personnel_appointments.models import Employee, Department, Appointment, Template, Account
from personnel_appointments.serializers import EmployeeSerializer, DepartmentSerializer, AppointmentSerializer, \
    TemplateSerializer, AccountSerializer
...
# Running all tests in the project: python manage.py test personnel_appointments
