...
from personnel_appointments.test.resource import *
from personnel_appointments.test.testing_utils import next_mock_employee
...
class SeleniumTests(LiveServerTestCase):
    ...
    def create_employee(self, **kwargs):
        ...
        # assert self.try_select_option(self.driver.find_element_by_id('staticAbteilung'),
        # f' {kwargs["department"]} '), f'Failed to select/create department "{kwargs["department"]}"'
