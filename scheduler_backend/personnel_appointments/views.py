...
from personnel_appointments.models import Employee, Department, Account, Template, Appointment
from personnel_appointments.serializers import EmployeeSerializer, DepartmentSerializer, AccountSerializer, \
    AppointmentSerializer, TemplateSerializer
from personnel_appointments.permissions import IsAccountOwner
from django_filters import rest_framework as filters
from personnel_appointments.utils import render_to_pdf, render_to_html, fill_template
import json
...
class EmployeeFilter(filters.FilterSet):
    ...
    class Meta:
        model = Employee
        fields = ['firstname', 'lastname', 'e_id', 'gender', 'date_of_birth', 'date_of_entry', 'wants_reminder',
                  'active',
...
class EmployeeViewSet(viewsets.ModelViewSet):
    """
    ViewSet for the `personnel_appointments.models.Employee` model.
...
class TemplateViewSet(viewsets.ModelViewSet):
    """
    ViewSet for the `personnel_appointments.models.Template` model.
...
class FilledTemplateViewSet(APIView):
    def get(self, request, pk, ek, format=None):
        ...
        if html:
            return HttpResponse(json.dumps({"template_body": html, "name": template.name}),
...
class DepartmentViewSet(viewsets.ModelViewSet):
    """
    ViewSet for the `personnel_appointments.models.Department` model.
...
class AppointmentViewSet(viewsets.ModelViewSet):
    """
    ViewSet for the `personnel_appointments.models.Appointment` model.
    """
...
class AccountViewSet(viewsets.ModelViewSet):
    """
    ViewSet for the `personnel_appointments.models.Account` custom user model.
    """
    lookup_field = 'id'
