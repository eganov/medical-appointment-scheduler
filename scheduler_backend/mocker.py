...
from personnel_appointments.test.resource import MOCK_DEPARTMENTS, MOCK_EMPLOYEES
from personnel_appointments.test.testing_utils import create_departments, create_employees
